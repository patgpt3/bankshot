  ...
  return (
    <main style={{ padding: 24 }}>
      <section style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, alignItems: 'center', padding: '48px 24px' }}>
        <div>
          <h1 style={{ fontSize: 48, lineHeight: 1.1, marginBottom: 12 }}>GameGenius Access Pass</h1>
          <p style={{ opacity: 0.8, fontSize: 18 }}>
            Preorder your GameGenius.ai Access Pass to unlock beta features, early content, and VIP community access.
          </p>
        ...
        <div>
          <div style={{ width: '100%', aspectRatio: '4/3', borderRadius: 16, border: '1px solid rgba(0,0,0,0.08)', background: 'linear-gradient(135deg, #1f2937, #111827)', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 700 }}>GAMEGENIUS  PREORDER</div>
        </div>
      </section>
    </main>
  );
