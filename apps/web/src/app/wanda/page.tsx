  ...
  return (
    <main style={{ padding: 24 }}>
      <section style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, alignItems: 'center', padding: '48px 24px' }}>
        <div>
          <h1 style={{ fontSize: 48, lineHeight: 1.1, marginBottom: 12 }}>Wanda Access Pass</h1>
          <p style={{ opacity: 0.8, fontSize: 18 }}>
            Preorder your Wanda.xyz Access Pass to secure early features, premium tools, and memberonly drops.
          </p>
        ...
        <div>
          <div style={{ width: '100%', aspectRatio: '4/3', borderRadius: 16, border: '1px solid rgba(0,0,0,0.08)', background: 'linear-gradient(135deg, rgba(17,24,39,0.9), rgba(17,24,39,0.6))', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 700 }}>WANDA  PREORDER</div>
        </div>
      </section>
    </main>
  );
