  ...
  return (
    <main style={{ padding: 24 }}>
      <section style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32, alignItems: 'center', padding: '48px 24px' }}>
        <div>
          <h1 style={{ fontSize: 48, lineHeight: 1.1, marginBottom: 12 }}>Streamy Access Pass</h1>
          <p style={{ opacity: 0.8, fontSize: 18 }}>
            Preorder your Streamy.rocks Access Pass for premium streaming tools and exclusive content.
          </p>
        ...
        <div>
          <div style={{ width: '100%', aspectRatio: '4/3', borderRadius: 16, border: '1px solid rgba(0,0,0,0.08)', background: 'linear-gradient(135deg, #111827, #0f172a)', display: 'grid', placeItems: 'center', color: '#fff', fontWeight: 700 }}>STREAMY  PREORDER</div>
        </div>
      </section>
    </main>
  );
